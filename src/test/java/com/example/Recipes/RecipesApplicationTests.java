...
//import com.example.Recipes.Models.Step;
...
//				.andExpect(MockMvcResultMatchers.jsonPath("minutesToMake").value(2))
//				.andExpect(MockMvcResultMatchers.jsonPath("reviews", IsCollectionWithSize.hasSize(1)))
//				.andExpect(MockMvcResultMatchers.jsonPath("ingredients", IsCollectionWithSize.hasSize(1)))
//				.andExpect(MockMvcResultMatchers.jsonPath("steps", IsCollectionWithSize.hasSize(2)));
//	}
//	@Test
//	@Order(2)
...
//				.andExpect((ResultMatcher) content().string(containsString("No recipe with ID " + recipeId + " could be found.")));
//	}
//	@Test
//	@Order(3)
//	public void testGetAllRecipesSuccessBehavior() throws Exception {
//		//set up get request for all recipe endpoint
//		mockMvc.perform((RequestBuilder) get("/recipes"))
//
...
//				.andExpect((ResultMatcher) jsonPath("$[0].name").value("test recipe"))
//
...
//				.andExpect((ResultMatcher) jsonPath("$[1].minutesToMake").value(2))
//
...
//				.andExpect((ResultMatcher) jsonPath("$[2].difficultyRating").value(5));
//	}
//	@Test
...
//				.andExpect((ResultMatcher) jsonPath("$").value("There are no recipes yet :( feel free to add one though"));
//	}
//	@Test
//	@Order(4)
